...
ACTOR=(
    ...
    actor_rollout_ref.actor.ppo_micro_batch_size_per_gpu=1 #${PPO_MICRO_BATCH_SIZE_PER_GPU}
...
REF=(
    ...
    actor_rollout_ref.ref.log_prob_micro_batch_size_per_gpu=1 #${PPO_MICRO_BATCH_SIZE_PER_GPU}
...
python3 -m verl.trainer.main_ppo \
    ...
    "${TRAINER[@]}" \
    "${EXTRA[@]}" \
    "$@" 2>&1 | tee logs/qwen3_5-35b-fsdp2-1kto2k-${start_time}.log